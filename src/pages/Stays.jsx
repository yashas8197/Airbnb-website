          ...
          <div className="col-md-8">
            <div className="card-body">
              ...
              <p className="card-text">
                A myth emerged that during the rebuilding of the structure after
                the Burning of Washington, white paint was applied to mask the
                burn damage it had suffered, giving the building its namesake
                hue.
              </p>
              <p className="card-text">
        ...
        <div className="row g-0 my-3">
          ...
          <div className="col-md-8">
            <div className="card-body">
              ...
              <p className="card-text">
                In the United Kingdom and Ireland, the term suburb simply refers
                to a residential area outside the city center, regardless of
          ...
          <div className="col-md-8">
            <div className="card-body">
              ...
              <p className="card-text">
                ...
                Bromley-by-Bow, Tower Hamlets, London. Located on the Blackwall
                Tunnel northern approach road, it is now owned and restored by
